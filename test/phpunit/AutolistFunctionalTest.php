...
/**
 * \file    test/functional/AutolistFunctionalTest.php
 * \ingroup autolist
 ...
 *
 * @package Testautolist
 */
class AutolistFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/autolist/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('autolist/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/autolist/admin/about.php');
		$this->authenticate();
		return $this->assertContains('autolist/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('autolistwidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modAutolist_AutolistTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAutolist_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
